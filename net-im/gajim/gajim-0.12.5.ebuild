...
src_prepare() {
	#non-upstream fix
	epatch "${FILESDIR}/0.12.5_autotools_install_pyfiles_in_pkglibdir.patch"
	# Make gajim work with xfce4-notifyd
	epatch "${FILESDIR}/0.12.5-notifyd.patch"
	# Fix sound paths
	epatch "${FILESDIR}/0.12.5-sound-path-fix.patch"
