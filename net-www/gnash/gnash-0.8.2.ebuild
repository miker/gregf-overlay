...
# $Header: /var/cvsroot/gentoo-x86/net-www/gnash/gnash-0.8.2.ebuild,v 1.3 2008/01/20 04:04:33  stub$
...
src_compile() {
	...
	#Copy missing file
	cp ${FILESDIR}/render_handler_ogl.h ${WORKDIR}/${P}/backend/render_handler_ogl.h
	econf \
